    ...
    <header className="h-14 bg-white border-b border-stone-100 flex items-center justify-between px-6 flex-shrink-0">
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center gap-2.5 hover:bg-amber-50 rounded-xl px-2.5 py-1.5 transition-colors"
        ...
        >
          ...
          <span className="font-semibold text-stone-700 text-sm hidden sm:block">{user.name}</span>
        ...
        {dropdownOpen && (
          <>
            ...
            <div className="absolute right-0 mt-2 w-52 bg-white rounded-2xl shadow-card-md border border-stone-100 z-20 overflow-hidden">
              {/* User info */}
